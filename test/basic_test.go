...
func TestRegisterUser(t *testing.T) {
	...
	args := &shared.UserArgs{Name: "TEST_NAME"}
	...
	args2 := &shared.FindAllMessagesArgs{User: "TEST_NAME"}
	resp2 := &shared.FindAllMessagesResp{}
...
func TestSendGroupMessage(t *testing.T) {
	...
	args := &shared.NewMessageArgs{Message: &shared.Message{Sender: "foo", Receiver: "", Message: "bar", Time: t_(k_)}}
